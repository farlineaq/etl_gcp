...
class ExtractStage(Extract):
    ...
    def filtered_blobs(self):
        client = self.client()
        blobs = client.list(self.conf.paths.fact_target_days.raw_data_path)
    ...
    def expectation_config(self) -> Dict[str, Any]:
        return {
            ...
            "project_name": str(self.conf.paths.entity_names.fact_target_days).lower()
        }
    ...
    def execute(self) -> DataFrame:
        ...
        return (
            ...
            .csv(self.conf.paths.fact_target_days.raw_data_path, header=True, sep=',')
        )
