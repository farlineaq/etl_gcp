...
BEGIN
    ...
    EXECUTE IMMEDIATE FORMAT("""
        ...
        VALUES
            ...
            (13, 'CLV Customer Life Time Value', 'Índice', 'Valor del ciclo de vida de los clientes en un periodo de tiempo determinado, presentado por cadena', CURRENT_TIMESTAMP()),
