    ...
    def _execute_delta(self, granularity: str) -> None:
        ...
        self.bq_client.sql(
            ...
            query_parameters={
                ...
                "date_to_calculate": self.conf.bigquery.indicadores.clientes_leales.endpoint_delta.date_to_calculate,
    ...
    def _execute_full(self, granularity: str) -> None:
        ...
        self.bq_client.sql(
            ...
            query_parameters={
                ...
                "start_date": self.conf.bigquery.indicadores.clientes_leales.endpoint_carga_inicial.start_date,
                "end_date": self.conf.bigquery.indicadores.clientes_leales.endpoint_carga_inicial.end_date,
